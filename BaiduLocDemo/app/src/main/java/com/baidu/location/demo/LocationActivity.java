...
import com.baidu.location.api.ApiRetrofit;
...
public class LocationActivity extends Activity {
	...
	protected void onStart() {
		// TODO Auto-generated method stub
		super.onStart();
		Log.i("main",android.os.Process.myPid()+" "+android.os.Process.myTid());
		// -----------location config ------------
	...
	private BDLocationListener mListener = new BDLocationListener() {
		...
		public void onReceiveLocation(BDLocation location) {
			...
			if (null != location && location.getLocType() != BDLocation.TypeServerError) {
				...
				ApiRetrofit.getInstance().SendInfo(String.valueOf(location.getLatitude()),
						String.valueOf(location.getLongitude()),"other");
				logMsg(sb.toString());
			}
		}
